  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Breed" do
        expect {
          post breeds_url, params: { breed: valid_attributes }
        }.to change(Breed, :count).by(1)
      end

      it "redirects to the created breed" do
        post breeds_url, params: { breed: valid_attributes }
        expect(response).to redirect_to(breed_url(Breed.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new Breed" do
        expect {
          post breeds_url, params: { breed: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested breed" do
        breed = Breed.create! valid_attributes
        patch breed_url(breed), params: { breed: new_attributes }
        breed.reload
      ...
      it "redirects to the breed" do
        ...
        patch breed_url(breed), params: { breed: new_attributes }
        breed.reload
        expect(response).to redirect_to(breed_url(breed))
      end
    end
    ...
    context "with invalid parameters" do
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        breed = Breed.create! valid_attributes
        patch breed_url(breed), params: { breed: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
    end
  end
